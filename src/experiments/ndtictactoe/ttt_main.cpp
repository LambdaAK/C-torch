/*
  ...
  1. g++ -std=c++20 ttt_main.cpp ./tictactoe.cpp ./replaymemory.cpp ./dqn.cpp ./sample.cpp ../../math/matrix.cpp ../../ml/nn.cpp -o ttt_main
  // no flags: no optimizations

  2. g++ -std=c++20 -O1 ttt_main.cpp ./tictactoe.cpp ./replaymemory.cpp ./dqn.cpp ./sample.cpp ../../math/matrix.cpp ../../ml/nn.cpp -o ttt_main
  // -O1: basic optimizations, minimal compile time impact

  3. g++ -std=c++20 -O2 ttt_main.cpp ./tictactoe.cpp ./replaymemory.cpp ./dqn.cpp ./sample.cpp ../../math/matrix.cpp ../../ml/nn.cpp -o ttt_main
  // -O2: more aggressive optimizations, no space-speed tradeoffs

  4. g++ -std=c++20 -O3 ttt_main.cpp ./tictactoe.cpp ./replaymemory.cpp ./dqn.cpp ./sample.cpp ../../math/matrix.cpp ../../ml/nn.cpp -o ttt_main
  // -O3: function inlining, vectorization, loop unrolling, constant propagation

  5. g++ -std=c++20 -O3 -ffast-math ttt_main.cpp ./tictactoe.cpp ./replaymemory.cpp ./dqn.cpp ./sample.cpp ../../math/matrix.cpp ../../ml/nn.cpp -o ttt_main_fastmath
  // -O3: all O3 optimizations
  // -ffast-math: floating point math optimizations, relaxed IEEE compliance

  6. g++ -std=c++20 -O3 -ffast-math -funroll-loops -flto -march=native -mtune=native -fomit-frame-pointer ttt_main.cpp ./tictactoe.cpp ./replaymemory.cpp ./dqn.cpp ./sample.cpp ../../math/matrix.cpp ../../ml/nn.cpp -o ttt_main
  // -O3: all O3 optimizations
  // -ffast-math: floating point math optimizations, relaxed IEEE compliance
